...
const OrderView = ({ match, history }) => {
  ...
  // like PlaceOrderView, but using this in the return jsx
            ...
            <ListGroup variant='flush'>
              ...
              <ListGroup.Item>
                <Message>
                  ...
                  <p>
                    Follow that link and scroll just past the table of contents
                    to find the login password and email.
                  </p>
                </Message>
              </ListGroup.Item>
              {loadingDeliver && <Loader />}
              {/* visible to admins, if paid & not delivered */}
              {userInfo &&
                userInfo.isAdmin &&
                order.isPaid &&
                !order.isDelivered && (
